...
// Sets up and maintains the Wi-Fi connection, and provides details that the communicator will need (e.g. IP address, MAC Address).

#ifndef HEADER_WIFI_MANAGER
#define HEADER_WIFI_MANAGER
